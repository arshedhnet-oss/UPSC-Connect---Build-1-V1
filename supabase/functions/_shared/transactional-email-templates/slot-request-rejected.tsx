...
const SlotRequestRejectedEmail = ({ menteeName = 'there', mentorName = 'the mentor', requestedDate = '', requestedTime = '', refundInitiated = false }: SlotRequestRejectedProps) => (
      ...
      <Container style={container}>
        ...
        {refundInitiated ? (
          ...
          <Section style={warningBox}>
            <Text style={detailLabel}>Refund Status</Text>
            <Text style={detailItem}>⚠️ Please contact our support team for refund assistance.</Text>
          </Section>
        )}
...
export const template = {
  ...
  previewData: { menteeName: 'Priya', mentorName: 'Rahul Sharma', requestedDate: 'Mon, Jan 15, 2025', requestedTime: '10:00 – 11:00', refundInitiated: true },
